...
<div class="container">
    ...
    <div class="page-header">
        Cấu hình Tuyển sinh
        <span>Năm <?php echo e($cfg['year']); ?></span>
    </div>
    ...
    <form method="POST" action="<?php echo e(route('admin.save')); ?>">
        ...
        <div class="field-row">
            <div class="field">
                ...
                <input type="text" name="year" value="<?php echo e($cfg['year']); ?>" placeholder="2025">
            </div>
            <div class="field">
                <label>Ngày thông báo kết quả</label>
                <input type="text" name="announcement_date" value="<?php echo e($cfg['announcement_date']); ?>" placeholder="20/5/2025">
            </div>
        </div>

        <div class="field">
            <label>Tên hệ thống</label>
            <input type="text" name="site_name" value="<?php echo e($cfg['site_name']); ?>">
        </div>
        ...
        <div class="field-row">
            <div class="field">
                ...
                <input type="text" name="start_time" value="<?php echo e($cfg['start_time']); ?>" placeholder="8h00 ngày 01/03/2025">
            </div>
            <div class="field">
                <label>Thời gian kết thúc</label>
                <input type="text" name="end_time" value="<?php echo e($cfg['end_time']); ?>" placeholder="17h00 ngày 31/03/2025">
            </div>
        </div>
        ...
        <div class="field-checkbox">
            <input type="checkbox" name="registration_open" id="registration_open"
                   <?php echo e($cfg['registration_open'] ? 'checked' : ''); ?>>
            <label for="registration_open">Mở đăng ký (hiện nút "Đăng ký dự thi" trên trang chủ)</label>
        </div>

        <div class="field">
            <label>URL form đăng ký</label>
            <input type="text" name="registration_url" value="<?php echo e($cfg['registration_url']); ?>"
        ...
        <div class="field">
            ...
            <input type="text" name="plan_url" value="<?php echo e($cfg['plan_url']); ?>">
        </div>

        <div class="field">
            <label>Hướng dẫn đăng ký dự thi</label>
            <input type="text" name="guide_url" value="<?php echo e($cfg['guide_url']); ?>">
        </div>
        ...
        <div class="field">
            ...
            <input type="text" name="sheet_trang_thai_ho_so" value="<?php echo e($cfg['sheet_trang_thai_ho_so']); ?>"
        ...
        <div class="field">
            ...
            <input type="text" name="sheet_thong_tin_du_thi" value="<?php echo e($cfg['sheet_thong_tin_du_thi']); ?>"
                   placeholder="https://docs.google.com/spreadsheets/d/.../export?format=csv">
        </div>
        ...
        <div class="field-row">
            <div class="field">
                ...
                <input type="text" name="csv_ket_qua_thi" value="<?php echo e($cfg['csv_ket_qua_thi']); ?>"
                       placeholder="result/kq_thi.csv">
                <small>Tương đối từ thư mục <code>public/</code></small>
            </div>
            <div class="field">
                <label>CSV kết quả phúc khảo</label>
                <input type="text" name="csv_ket_qua_phuc_khao" value="<?php echo e($cfg['csv_ket_qua_phuc_khao']); ?>"
        ...
        <div class="field-row">
            <div class="field">
                ...
                <input type="text" value="<?php echo e(config('tuyen_sinh.admin_user')); ?>" disabled>
...
</html><?php /**PATH C:\xampp\htdocs\project_web\resources\views/admin/index.blade.php ENDPATH**/ ?>