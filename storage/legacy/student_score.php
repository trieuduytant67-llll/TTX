...
$sheetData = readLocalCsv($data_path_kqthi);
...
//                echo "</tr>";
            ...
            echo "<h3>BẢNG ĐIỂM THI:</h3>";
            echo '<table class="two-columns" style="width:100%">';
            echo '<thead>';
            echo '<tr>';
            echo '<th>Môn thi</th>';
            echo '<th>Điểm thi</th>';
//                echo '<th style="text-align: center;">Ghi chú</th>';
            echo '</tr>';
            echo '</thead>';
            echo '<tbody>';
            ...
            foreach ($diem_labels as $index => $ten_mon) {
                ...
                $ghi_chu = '';
                // Thêm ghi chú cho các môn có yêu cầu điều kiện xét tuyển
                if ($index === $COT['NGU_VAN'] || $index === $COT['TOAN_1'] || $index === $COT['TIENG_ANH']) {
                    $diem_float = floatval($diem);
                    if ($diem_float < 4.0) {
                        $ghi_chu = '<span class="condition-note" style="color: #dc3545;">✗ Không đủ điều kiện</span>';
                    } else {
                        $ghi_chu = '<span class="condition-note" style="color: #28a745;">✓ Đủ điều kiện</span>';
                    }
                }
                echo "<tr>";
